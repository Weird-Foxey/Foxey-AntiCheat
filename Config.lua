...
Config.openMenu = 288 -- Standard M if you want to change it use the codes from https://docs.fivem.net/docs/game-references/controls/
...
Config.AntiBlacklistedWeapons      =   true	-- bans super models
